 ...
 * [blurhash] は imeta 由来のぼかし（#140）。ポスターが無い/読み込み中の黒画面の代わりに敷く。
 */
@Composable
expect fun VideoPlayer(url: String, posterUrl: String? = null, blurhash: String? = null, modifier: Modifier = Modifier)
